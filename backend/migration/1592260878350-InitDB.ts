...
export class InitDB1592260878350 implements MigrationInterface {
    name = 'InitDB1592260878350'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "product_brand" ("brandId" integer NOT NULL, "productId" integer NOT NULL, "image" character varying(255) NOT NULL, CONSTRAINT "PK_e005cc56c8704b41875b271dbde" PRIMARY KEY ("brandId", "productId"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "address" ("id" SERIAL NOT NULL, "district" character varying(100) NOT NULL, "street" character varying(100) NOT NULL, "number" integer NOT NULL, "cep" character varying NOT NULL, "lat" character varying(12), "log" character varying(12), "obs" character varying(255), "mainAddress" boolean NOT NULL DEFAULT false, "cityId" integer NOT NULL, "customerId" integer, "marketId" integer, CONSTRAINT "PK_d92de1f82754668b5f5f5dd4fd5" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "mean_of_payment" ("id" SERIAL NOT NULL, "type" character varying(30) NOT NULL, "obs" character varying(255), CONSTRAINT "PK_bd91f824d9c9b43518680ba7fa3" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "product_market" ("brandId" integer NOT NULL, "productId" integer NOT NULL, "marketId" integer NOT NULL, "codProductInMarket" integer NOT NULL, "price" real NOT NULL, "discount" real NOT NULL, "quantity" integer NOT NULL, CONSTRAINT "PK_22034df563c938d523fe87fc0ba" PRIMARY KEY ("brandId", "productId", "marketId", "codProductInMarket"))`, undefined);
