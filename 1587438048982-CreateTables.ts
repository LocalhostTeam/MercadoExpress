...
export class CreateTables1587438048982 implements MigrationInterface {
    name = 'CreateTables1587438048982'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "product_brand" ("id" SERIAL NOT NULL, "image" character varying(255) NOT NULL, "productId" integer, "brandId" integer, CONSTRAINT "PK_2eb5ce4324613b4b457c364f4a2" PRIMARY KEY ("id"))`, undefined);
